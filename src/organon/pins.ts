...
export namespace Pins {
  ...
  export const HEAD_FILE = "provenance-pins.json"
  ...
  export function head(): Head | null {
    for (const f of [HEAD_FILE, "variant-pins.json", "ship-pins.json", "family-pins.json", "substance-pins.json", "socket-pins.json"]) {
